// PRE Web GUI — macOS Reminders.app integration
// Zero-config reminders via EventKit (compiled Swift) — works with iCloud or any configured account
// Uses compiled Swift binary for reads (fast), AppleScript for writes (single-item, tolerable)
